...
class Config(object):
	API_ID = int(os.environ.get("API_ID", "17584090"))
	API_HASH = os.environ.get("3f779654fdd3b9278fd95869aabf4593")
	BOT_TOKEN = os.environ.get("")
	BOT_USERNAME = os.environ.get("LuxFilestorebot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002245047243"))
	SHORTLINK_URL = os.environ.get('SHORTLINK_URL')
	SHORTLINK_API = os.environ.get('SHORTLINK_API')
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "7252430326"))
	DATABASE_URL = os.environ.get("mongodb+srv://Aaki8490:vnCMn6F5l8nqXxFe@cluster0.jlgdebe.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002216982774")
